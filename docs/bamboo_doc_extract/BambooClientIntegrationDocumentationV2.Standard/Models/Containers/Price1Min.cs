// <copyright file="Price1Min.cs" company="APIMatic">
...
namespace BambooClientIntegrationDocumentationV2.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<Price1Min>),
        new Type[] {
            typeof(NumberCase),
    ...
    public abstract class Price1Min
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The Price1Min instance, wrapping the provided int value.
        /// </returns>
        public static Price1Min FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The Price1Min instance, wrapping the provided double value.
        /// </returns>
        public static Price1Min FromPrecision(double precision)
        {
        ...
        private sealed class NumberCase : Price1Min, ICaseValue<NumberCase, int>
        {
            public int _value;
        ...
        private sealed class PrecisionCase : Price1Min, ICaseValue<PrecisionCase, double>
        {
