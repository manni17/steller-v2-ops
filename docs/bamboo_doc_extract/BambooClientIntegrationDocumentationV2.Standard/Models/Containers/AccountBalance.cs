...
namespace BambooClientIntegrationDocumentationV2.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<AccountBalance>),
        new Type[] {
    ...
    public abstract class AccountBalance
    {
        ...
        /// </summary>
        /// <returns>
        /// The AccountBalance instance, wrapping the provided double value.
        /// </returns>
        public static AccountBalance FromPrecision(double precision)
        {
        ...
        /// </summary>
        /// <returns>
        /// The AccountBalance instance, wrapping the provided int value.
        /// </returns>
        public static AccountBalance FromNumber(int number)
        {
        ...
        private sealed class PrecisionCase : AccountBalance, ICaseValue<PrecisionCase, double>
        {
        ...
        private sealed class NumberCase : AccountBalance, ICaseValue<NumberCase, int>
        {
            public int _value;
