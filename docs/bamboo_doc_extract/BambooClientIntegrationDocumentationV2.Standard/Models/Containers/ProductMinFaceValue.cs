// <copyright file="ProductMinFaceValue.cs" company="APIMatic">
...
namespace BambooClientIntegrationDocumentationV2.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ProductMinFaceValue>),
        new Type[] {
            typeof(NumberCase),
    ...
    public abstract class ProductMinFaceValue
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The ProductMinFaceValue instance, wrapping the provided int value.
        /// </returns>
        public static ProductMinFaceValue FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ProductMinFaceValue instance, wrapping the provided double value.
        /// </returns>
        public static ProductMinFaceValue FromPrecision(double precision)
        {
        ...
        private sealed class NumberCase : ProductMinFaceValue, ICaseValue<NumberCase, int>
        {
            public int _value;
        ...
        private sealed class PrecisionCase : ProductMinFaceValue, ICaseValue<PrecisionCase, double>
        {
