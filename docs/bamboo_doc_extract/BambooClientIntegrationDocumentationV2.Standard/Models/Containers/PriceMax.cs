// <copyright file="PriceMax.cs" company="APIMatic">
...
namespace BambooClientIntegrationDocumentationV2.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PriceMax>),
        new Type[] {
    ...
    public abstract class PriceMax
    {
        /// <summary>
        /// This is Precision case.
        /// </summary>
        /// <returns>
        /// The PriceMax instance, wrapping the provided double value.
        /// </returns>
        public static PriceMax FromPrecision(double precision)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PriceMax instance, wrapping the provided int value.
        /// </returns>
        public static PriceMax FromNumber(int number)
        {
        ...
        private sealed class PrecisionCase : PriceMax, ICaseValue<PrecisionCase, double>
        {
        ...
        private sealed class NumberCase : PriceMax, ICaseValue<NumberCase, int>
        {
            public int _value;
