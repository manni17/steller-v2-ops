// <copyright file="ProductMaxFaceValue.cs" company="APIMatic">
...
namespace BambooClientIntegrationDocumentationV2.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ProductMaxFaceValue>),
        new Type[] {
            typeof(NumberCase),
    ...
    public abstract class ProductMaxFaceValue
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The ProductMaxFaceValue instance, wrapping the provided int value.
        /// </returns>
        public static ProductMaxFaceValue FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ProductMaxFaceValue instance, wrapping the provided double value.
        /// </returns>
        public static ProductMaxFaceValue FromPrecision(double precision)
        {
        ...
        private sealed class NumberCase : ProductMaxFaceValue, ICaseValue<NumberCase, int>
        {
            public int _value;
        ...
        private sealed class PrecisionCase : ProductMaxFaceValue, ICaseValue<PrecisionCase, double>
        {
